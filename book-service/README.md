...
```bash
$ mvn archetype:generate -DartifactId=book-service -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=bookapp -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd book-service
$ mvn clean package
